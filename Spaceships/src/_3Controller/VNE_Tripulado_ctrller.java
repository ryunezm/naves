 ...
 * @author ryunezm
 */
public class VNE_Tripulado_ctrller {
    ...
    public static void insertarDatos(String nombre, int anoCreacion, String AgenciaPart,
                    ...
                    int capacidadPersonas, String Mision){
        String sqlQuery = "INSERT INTO Tripulado ("
                                                + "Nombre, "
                                                + "Fecha_de_creacion, "
                                                + "Agencias_espaciales,"
                                                + "Activo, "
        ...
        try {
            ...
            ptst.setString(9, Mision);
            ptst.executeUpdate();
            System.out.println("Los datos han sido guardados correctamente en la tabla Tripulado de la base de datos");
            
        } catch (SQLException e) {
            System.out.println("Error al insertar datos en la tabla Tripulado. Log: "+e);
        }
    ...
    public static void consultarNombre(String nombre){
        String sqlQuery = "SELECT * FROM Tripulado WHERE ((Nombre+Fecha_de_creacion+Agencias_espaciales+Activo+Fecha_de_retiro+Peso+Combustible+Capacidad_de_personas+Mision) LIKE ?)";
    ...
    //Listar todos los elementos registrados en la base de datos
    public static void listarTodos(){
        String sqlQuery = "SELECT * FROM Tripulado";
    ...
    public static void consultaAvanzada(String cadena){
        String sqlQuery = "SELECT * FROM Tripulado WHERE Nombre LIKE ?";
        try {
            Connection conn = SQLite.obtConexion();
            PreparedStatement ptst;
            ResultSet rs;
